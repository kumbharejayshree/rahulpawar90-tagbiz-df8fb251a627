...
public class PreferenceHelper {
    ...
    public static void setValueString(Context context, String key, String value) {
        SharedPreferences prefs = context.getSharedPreferences(AppConfig.TAG_PREF, Context.MODE_PRIVATE);
    ...
    public static String getValueString(Context context, String key) throws NullPointerException {
        SharedPreferences prefs = context.getSharedPreferences(AppConfig.TAG_PREF, Context.MODE_PRIVATE);
    ...
    public static boolean getBooleanValue(Context context, String key) throws NullPointerException{
        SharedPreferences prefs = context.getSharedPreferences(AppConfig.TAG_PREF, Context.MODE_PRIVATE);
        return prefs.getBoolean(key, false);
    }
