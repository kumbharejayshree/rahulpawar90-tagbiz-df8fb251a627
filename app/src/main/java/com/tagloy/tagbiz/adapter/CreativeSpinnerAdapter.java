...
public class CreativeSpinnerAdapter extends ArrayAdapter<Organization> {
    private Context context;
    private ArrayList<Organization> organizations;
    private CreativeSpinnerAdapter spinnerAdapter;
    private boolean isFromView = false;
    private Spinner spinner;

    public CreativeSpinnerAdapter(Context context, int resource, List<Organization> organizationList, Spinner spinner){
    ...
    public View getCustomView(int position, View convertview, ViewGroup parent){
        ViewHolder viewHolder;
         if (convertview == null){
             ...
             convertview = layoutInflater.inflate(R.layout.creative_spinner_item,null);
             viewHolder = new ViewHolder();
             viewHolder.outletCheck = convertview.findViewById(R.id.outCheck);
             viewHolder.outletNameText = convertview.findViewById(R.id.outNameText);
